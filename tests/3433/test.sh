...
timeout --preserve-status 10 $ROOT_DIR/jerryscript/build/bin/jerry $IN_FILE 2>&1 | grep -m 1 -q "context_p->stack_top_uint8 == SCAN_STACK_CATCH_STATEMENT"
