...
function assertEquals ( a , b ) { String ( a === b ) ; 
} 
...
class MyOtherArray extends Array { static get [ Symbol .species ] ( ) { return MyArray ; 
} } 
...
class MyNonArray extends Array { static get [ Symbol .species ] ( ) { return MyObject ; 
} } 
class MyObject { } 
...
class MyDefaultArray extends Array { static get [ Symbol .species ] ( ) { return undefined ; 
} } 
...
class MyThrowingArray extends Array { static get [ Symbol .species ] ( ) { throw new SpeciesError ; 
} } 
function assertThrows ( a , b ) { try { a ( ) ; 
} catch ( e ) { String ( e instanceof b ) ; 
} 
} 
assertThrows ( ( ) => new MyThrowingArray ( ) .map ( ( ) => { } ) , SpeciesError ) ; 
Object .defineProperty ( MyThrowingArray .prototype , 'constructor' , { get ( ) { throw new ConstructorError ; 
} } ) ; 
assertThrows ( ( ) => new MyThrowingArray ( ) .map ( ( ) => { } ) , ConstructorError ) ; 
class id_0 extends Array { constructor ( ... args ) { super ( ... args ) ; 
Object .assertThrows ( this ) ; 
} } 
assertThrows ( ( ) => new id_1 ( [ 1 ] ) .map ( ( ) => 0 ) , TypeError ) ; 
assertThrows ( ( ) => new id_2 ( [ 1 ] ) .filter ( ( ) => true ) , TypeError ) ; 
assertThrows ( ( ) => new id_3 ( [ 1 ] ) .slice ( 0 , 1 ) , TypeError ) ; 
assertThrows ( ( ) => new id_4 ( [ 1 ] ) .splice ( 0 , 1 ) , TypeError ) ; 
assertThrows ( ( ) => new id_5 ( [ ] ) .concat ( [ 1 ] ) , TypeError ) ; 
var count ; 
var params ; 
class MyObservedArray extends Array { constructor ( ... args ) { super ( '"use strict"; var x = "\\411";' ) ; 
params = args ; 
} static get [ Symbol .species ] ( ) { count ++ 
return this ; 
} } 
function assertArrayEquals ( value , expected , type ) { String ( expected .length === value .length ) ; 
for ( var i = 0 ; i < value .length ; ++ i ) { assertEquals ( expected [ i ] , value [ i ] ) ; 
} 

} 
count = 0 ; 
params = undefined ; 
assertEquals ( MyObservedArray , new MyObservedArray ( ) .map ( ( ) => { } ) .constructor ) ; 
assertEquals ( 1 , count ) ; 
assertArrayEquals ( [ 0 ] , params ) ; 
count = 0 ; 
params = undefined ; 
assertEquals ( MyObservedArray , new MyObservedArray ( ) .filter ( ( ) => { } ) .constructor ) ; 
assertEquals ( 1 , count ) ; 
assertArrayEquals ( [ 0 ] , params ) ; 
count = 0 ; 
params = undefined ; 
assertEquals ( MyObservedArray , new MyObservedArray ( ) .concat ( ) .constructor ) ; 
assertEquals ( 1 , count ) ; 
assertArrayEquals ( [ 0 ] , params ) ; 
count = 0 ; 
params = undefined ; 
assertEquals ( MyObservedArray , new MyObservedArray ( ) .slice ( ) .constructor ) ; 
assertEquals ( 1 , count ) ; 
assertArrayEquals ( [ 0 ] , params ) ; 
count = 0 ; 
params = undefined ; 
assertEquals ( MyObservedArray , new MyObservedArray ( ) .splice ( ) .constructor ) ; 
assertEquals ( 1 , count ) ; 
assertArrayEquals ( [ 0 ] , params ) ; 