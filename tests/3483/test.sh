...
timeout --preserve-status 10 $ROOT_DIR/jerryscript/build/bin/jerry $IN_FILE 2>&1 | grep -m 1 -q "Assertion 'object_p->type_flags_refs >= ECMA_OBJECT_REF_ONE' failed"
