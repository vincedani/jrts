...
timeout --preserve-status 10 $ROOT_DIR/jerryscript/build/bin/jerry $IN_FILE 2>&1 | grep -m 1 -q "Assertion 'ECMA_STRING_IS_REF_EQUALS_TO_ONE (string_p)' failed"
